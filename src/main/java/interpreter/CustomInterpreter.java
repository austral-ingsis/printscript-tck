...
public class CustomInterpreter implements PrintScriptInterpreter{
    ...
    @Override
    public void execute(File src, String version,org.florresoagli.printscript.Observer emitter, org.florresoagli.printscript.Observer handler, org.florresoagli.printscript.InputProviderReader  provider) {
