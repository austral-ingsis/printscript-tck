...
public class PullInterpreter implements PrintScriptInterpreter {
  ...
  private Interpreter createInterpreter(BrokerObserver<String> observer) {
    return new org.example.PrintScriptInterpreter(Map.ofEntries(Map.entry(ObserverType.PRINTLN_OBSERVER, observer)), List.of());
  }
